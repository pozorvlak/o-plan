...
; Modifications for O-Plan:
;  * Avoid calling COMPILE at run-time in AKCL.

;------------------------------------------------------------------------

;Copyright 1989,1990,1991 by the Massachusetts Institute of Technology, Cambridge, 
;Massachusetts.
...
;he Language Second Edition, Guy L. Steele Jr, Digital press, 1990,
...

;;; Pseudo-compiler for the O-Plan version

(defun maybe-compile (name lambda-expr)
  (assert (eq name nil))
  #+kcl
