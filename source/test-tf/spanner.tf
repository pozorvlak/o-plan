...
;;;      achieve_after_end = begin_of start
...
;;; the default above for achieve_after_end is "start", no solution will
;;; be found for task spanner_2.  Try this by altering the achieve_after_end
;;; to be begin_of self.  Putting in the do_cleanup schema will enable
;;; a solution to be found even in this case, but then the optimal
...
schema do_setup_2;
  ...
  ;;; achieve allows any tactics to satisfy condition.
  ;;; could be only_use_for_query as no schema provides this effect
end_schema;
