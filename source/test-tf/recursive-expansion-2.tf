...
;;; Updated: Sun Jan  3 15:51:05 1999 by Jeff Dalton

;;; This version uses a "satisfies" actor instead of a compute condition
;;; to test for the non-leaf case.
...
schema expand;
  vars ?branching = ?{satisfies numberp},
       ?depth     = ?{and ?{satisfies numberp} ?{satisfies > 0}},
       ?d         = ?{satisfies numberp},
