;;; A simple house-building domain with resources, a.k.a. house-5

;;; Author: Jeff Dalton

;;; Created: June 1993
;;; Updated: Wed Nov 30 00:22:18 1994 by Jeff Dalton
...
schema secure_house_builder;
  ...
  conditions only_use_if {proof_against wolf ?material} at 1,
             supervised {material wall} = ?material at 4 from [1],
             supervised {walls built} at 2 from [1],
             supervised {walls built} at 3 from [1],
             unsupervised {wolf_proof door} at 4,
             unsupervised {wolf_proof windows} at 4;
end_schema;
