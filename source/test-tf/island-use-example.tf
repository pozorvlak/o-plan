;;; A version of the island rescue web demo using "use" constraints

;;; Updated: Wed May 14 03:35:27 1997 by Jeff Dalton
...
task Pacifica_evacuation_with_no_time_limit;
  nodes sequential
          1 start,
          2 finish
        end_sequential;
...
;;; The too_little_time task is found to have no solution
;;; after 2649 AM cycles, 542 alts chosen, 542 poisons.

task Pacifica_evacuation_with_too_little_time;
  nodes sequential
          1 start,
          2 finish
        end_sequential;
  conditions
     ...
     achieve {evac_status Calypso } = {  0  20} at 2,
     achieve {safe_at Delta} at 2;
  time_windows 0..0~10:00 at 2;
end_task;

task Pacifica_evacuation_with_even_less_time;
  nodes sequential
          1 start,
          2 finish
        end_sequential;
  conditions
     ...
     achieve {evac_status Calypso } = {  0  20} at 2,
     achieve {safe_at Delta} at 2;
  time_windows 0..0~8:00 at 2;
end_task;

;;; From File: island-rescue-use-example.tf
