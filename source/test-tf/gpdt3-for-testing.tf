...
;;; Updated: Wed Jul 15 16:01:43 1998 by John Levine
;;; Copyright: (c) 1997, AIAI, University of Edinburgh

;;; *** start of bit to remove including this line ***
...
task to_test_move_injured_by_road;
  nodes
    1 start,
    2 finish,
...
;;; *** end of bit to remove including this line ***
...
;;; Dummy task to make sure all there are levels for all the
;;; initial effects we'll use.
...
task effects_dummy;
  ...
  effects
    {weather} = clear at 1,
    {road_status Abyss_Exodus} = open at 1,
    {road_status Delta_Abyss} = open at 1,
    {road_status Abyss_Barnacle} = open at 1,
    {road_status Barnacle_Calypso} = open at 1,
    {road_status Calypso_Delta} = open at 1,
    {location ??} = Delta at 1,
    {available ??} = true at 1,
