...
;;; Updated: Fri Nov 25 21:43:54 1994 by Jeff Dalton
...
;;; The schemas differ only in the numbers moved.

meta_schema meta_move;
  instantiates {meta_move ?m ?c};
  ...
  nodes
     ...
     end_sequential;
  conditions
     compute {next_state ?state ?m ?c} = ?new_state,
     only_use_if {tried ?new_state} = false;
  effects {tried ?state} = true at begin_of self;
end_meta_schema;

schema move_2_m;
  instance_of {meta_move 2 0};
end_schema;

schema move_2_c;
  instance_of {meta_move 0 2};
end_schema;

schema move_1_m;
  instance_of {meta_move 1 0};
end_schema;

schema move_1_c;
  instance_of {meta_move 0 1};
end_schema;

schema move_1_m_1_c;
  instance_of {meta_move 1 1};
end_schema;
